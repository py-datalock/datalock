"""
datalock/reports/compliance_report.py
===================================
...
Uso:
    report = dd.compliance_report(df, reports, audit=audit)
...
<body>
<div style="position:sticky;top:0;background:white;border-bottom:2px solid #dee2e6;
  ...
  <span style="color:#666;font-size:.9em">{self.dataset_name} — {self.generated_at[:10]}</span>
...
<div class="footer">
  Relatório gerado automaticamente pela biblioteca <strong>datalock</strong>.<br>
  ...
  conforme exigido pela Lei n° 13.709/2018 (LGPD).
    ...
    def to_pdf(self, path: str) -> None:
        ...
        try:
            ...
            raise ImportError(
                "dd.compliance_report().to_pdf() requer weasyprint. "
...
def build_compliance_report(
    ...
    *,
    ...
    Args:
        ...
        privacy_score: Dict do privacy_score (de dd.profile()). None = calcula.
    ...
    return ComplianceReport(
        ...
        generated_by  = f"datalock {_lg.__version__}",
        title         = title,
