...
# Auditoria global — configurada via dd.configure(audit=AuditReport())
_GLOBAL_AUDIT: Optional[Any] = None
_DEFAULT_SALT: Optional[str] = None  # salt padrão global configurado via dd.configure()
    ...
    **read_kwargs,
    ...
    if file_size > MAX_FILE_SIZE_BYTES:
        raise ValueError(
            ...
            f"Use dd.stream() ou dd.read(..., chunksize=50_000) para arquivos grandes."
        )
