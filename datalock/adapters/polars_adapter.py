...
2. Serialização para .dlk: pl.DataFrame.write_parquet() é 20–40% mais rápido
...
_POLARS_INSTALL_MSG = (
    "Polars não está instalado. Execute: pip install 'datalock[polars]'\n"
