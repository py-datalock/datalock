...
Usado por lg.profile() como report.privacy_score.
"""
...
def calculate(
    df: Any,
    reports: Dict[str, Any],           # Dict[str, ColumnReport] do lg.scan()
    *,
    ...
    if total >= 90:
        ...
        recommendation = "Risco considerável. Execute lg.mask() com salt antes de qualquer compartilhamento."
    else:
